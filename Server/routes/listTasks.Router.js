...
const { getTasks, newTask, switchChecked, changeChecked, deleteTask, deleteAllTask} = require("../controllers/listTask.js");
...
router.delete("/deleteAll", deleteAllTask) //* DELETE Elimina todas las tareas
